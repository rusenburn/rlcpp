...
echo "  AlphaYugo bot on WebGPU (in index.html, and az.html alone):"
echo "    az.html  az_worker.js  az_snapshot.js  migoyugo_az.onnx"
echo "    migoyugo_az.js       migoyugo_az.wasm       (asyncify bridge)"
echo "    migoyugo_az_jspi.js  migoyugo_az_jspi.wasm  (JSPI bridge)"
echo ""
echo "Two builds of the same engine, differing only in how the search suspends"
echo "while the GPU works. az_worker.js feature-detects and fetches ONE of them:"
echo "JSPI on Chrome 137+/Firefox 139+, asyncify everywhere else. Append"
echo "?bridge=jspi or ?bridge=asyncify to force either and compare."
echo ""
...
echo "            http://localhost:8000/az.html (AlphaYugo bot)"
echo ""
