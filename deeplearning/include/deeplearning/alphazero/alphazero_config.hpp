#ifndef RL_DEEPLEARNING_ALPHAZERO_CONFIG_HPP_
#define RL_DEEPLEARNING_ALPHAZERO_CONFIG_HPP_
...
struct AZConfig
{
    ...
    std::optional<std::string> network_load_path;
    std::optional<std::string> network_save_name;
