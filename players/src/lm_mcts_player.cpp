...
#include <players/lm_mcts_player.hpp>

namespace rl::players
{
LMMctsPlayer::LMMctsPlayer(int n_game_actions,
...
LMMctsPlayer::~LMMctsPlayer() = default;

int LMMctsPlayer::choose_action(const std::unique_ptr<rl::common::IState>& state_ptr)
{
    auto mcts = LMMcts(evaluator_ptr_->copy(), n_game_actions_, cpuct_, temperature_);
