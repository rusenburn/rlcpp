...
public:
    Amcts2(int n_game_actions, std::unique_ptr<IEvaluator> evaluator_ptr, float cpuct, float temperature, int max_async_simulations, float default_visits, float default_wins);
    ~Amcts2()override;
